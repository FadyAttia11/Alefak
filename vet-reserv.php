...
session_start();
    ...
    $all_reservations_query = "select * from reservations join users on reservations.owner_name = users.user_name";
    $all_reservations = mysqli_query($con, $all_reservations_query);
?>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <ul>
          ...
          <li class="active"><a href="vet-reserv.php">Vet Reservations</a></li>          
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
            <?php
                while($row = mysqli_fetch_array($all_reservations)) {
            ?>

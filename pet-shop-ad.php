    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        if(isset($_POST['all'])) {
          ...
          $all_store = mysqli_query($con, $all_store_query);
            ...
            $delete_item_query = "delete from store where id = '$item_id'";
            $delete_item = mysqli_query($con, $delete_item_query);

            if($delete_item) {
                echo "successfully deleted your item";
                header('Location: pet-shop-ad.php');
            }
        }
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="pet-shop-ad.php">Pet Shop</a></li>
            ...
            <div class="row">
                ...
                <div class="card h-100">
                    ...
                    <form method="post">
                        ...
                        <input type="submit" class="btn btn-danger" value="Delete This Item">
                    </form>
                    </div>
